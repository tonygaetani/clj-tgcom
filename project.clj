(defproject clj-tgcom "0.1.4-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "clj-tgcom.core/on-figwheel-reload"}

                :compiler {:main clj-tgcom.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/clj_tgcom.js"
